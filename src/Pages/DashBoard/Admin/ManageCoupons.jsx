            ...
            {isModalOpen && (
                <div className="fixed inset-0 bg-black/40 flex justify-center items-center z-50">
                    <div className="bg-white rounded-xl shadow-xl p-6 w-[95%] max-w-md relative">
                        <h3 className="text-xl font-semibold mb-4 text-center text-blue-700">Add New Coupon</h3>
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full border px-3 py-2 rounded-md resize-none focus:outline-none focus:ring-2 focus:ring-blue-500"
                                    rows={3}
                                />
                            </div>
