...
const Announcements = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="bg-gradient-to-r from-blue-100 via-purple-100 to-pink-100 p-8 rounded-2xl shadow-lg border border-purple-200">
          ...
          <div className="space-y-6">
            {data.map(({ _id, title, description, createdAt, author }) => (
              ...
              >
                ...
                <p className="text-gray-700 text-base leading-relaxed mb-3">{description}</p>
                <div className="text-sm text-gray-500 italic flex justify-between">
                  <span>By: {author}</span>
                  <span>
