...
const Testimonials = () => {
  ...
  return (
    <section className="mt-24 py-24 bg-base-200/70 ">
      ...
      <div className="max-w-7xl mx-auto">
        <Marquee pauseOnHover speed={60} gradient={false}>
          {testimonials.map((item, idx) => (
            <div
              key={idx}
              className="bg-gray-100 p-6 rounded-2xl shadow-lg m-3 w-80 h-72 flex flex-col justify-between"
            >
        ...
        <Marquee pauseOnHover direction="right" speed={60} gradient={false}>
          {testimonials.map((item, idx) => (
            <div
              key={idx}
              className="bg-gray-100 p-6 rounded-2xl shadow-lg m-3 w-80 h-72 flex flex-col justify-between"
